      ...
      <Row className="gutter mb-4">
        <Col xs={12} lg={6}>
          <Widget className="widget-p-md">
            ...
            <Notification type="info" withIcon />
            <Notification type="error" withIcon />
            <Notification type="success" withIcon />
            <Notification type="warning" withIcon />
          </Widget>
        </Col>
        <Col xs={12} lg={6} className="mt-4 mt-lg-0">
          <Widget className="widget-p-md">
            <div className="headline-2 mb-4">
              Notifications Types Examples, without icons
            </div>
